                      ...
                      child: Container(
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: getPadding(left: 1, top: 44, right: 10),
                              child: Text(
                                "lbl_register".tr,
                            ...
                            Padding(
                              padding: getPadding(left: 1, top: 25, right: 10),
                              child: Text(
                                "lbl_email_id".tr,
                                overflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                            ...
                            GestureDetector(
                              onTap: () => {gotoLogin()},
                              child: Container(
                                margin: getMargin(left: 26, top: 33, right: 26),
                                child: Center(
                                  child: RichText(
                                    text: TextSpan(
                                      children: [
      ...
      try {
        ...
        controller.callCreateUsers(
          ...
          successCall: () {
            ...
            if (controller.postItemsResp.sId != null) {
              Get.find<PrefUtils>().setUserid(controller.postItemsResp.sId!);
              Get.find<PrefUtils>().setUsername(controller.email.text);

              // Navigate to home screen
              Get.offNamed(AppRoutes.homeScreen);
            } else {
              Get.snackbar('Error', 'Failed to get user data from response');
            }
          },
          errCall: () {
